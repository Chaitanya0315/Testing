...
|2q|Player is able to view the average solved / created ratio inide player statistics|Player clicks on the 'Player Statistics' button from the home page |Player is able to view the average solved to created ratio for each player|Player is able to view the average solved to created ratio for each player|Pass|To test that a player able to view the average solved / created ratio inide player statistics|

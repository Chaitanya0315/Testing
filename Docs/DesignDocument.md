...
The center activity is a scenario when a player chooses to solve an existing scramble. The player will be able to view the list of unsolved scramble with the ones still in-progress at the top of the list.
